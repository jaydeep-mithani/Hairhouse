...
export function Modal({ children, cancelLink }: { children: React.ReactNode; cancelLink: string }) {
  return (
    <div className="relative z-50" aria-labelledby="modal-title" role="dialog" aria-modal="true" id="modal-bg">
        ...
        <div className="flex items-center justify-center min-h-full p-4 text-center sm:p-0">
          <div
            ...
            <div className="absolute top-0 right-0 hidden pt-4 pr-4 sm:block">
              <Link to={cancelLink} className="p-4 -m-4 transition text-primary hover:text-primary/50">
