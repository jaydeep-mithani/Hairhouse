...
// import { PageHeader, Section, Button, HygraphSections } from '~/components'
...
export default function Policies() {
  // const { policy, sections } = useLoaderData<typeof loader>()
  ...
  return (
    <>
      {/* <Section padding="all" display="flex" className="flex-col items-baseline w-full gap-8 md:flex-row">
        ...
        <PageHeader heading={policy.title} className="grid items-start flex-grow gap-4 md:sticky top-36 md:w-5/12">
