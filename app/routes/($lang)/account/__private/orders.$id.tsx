...
import type { Order, OrderLineItem, DiscountApplicationConnection } from '@shopify/hydrogen/storefront-api-types'
import { json, redirect, type MetaFunction, type LoaderArgs } from '@shopify/remix-oxygen'
...
export async function loader({ request, context, params }: LoaderArgs) {
  ...
  const data = await context.storefront.query<{ node: Order }>(CUSTOMER_ORDER_QUERY, { variables: { orderId } })
  ...
  const discountApplications = flattenConnection(order.discountApplications as DiscountApplicationConnection)
