...
import { CollectionConnection, PageConnection, ProductConnection } from '@shopify/hydrogen/storefront-api-types'
...
export async function loader({ request, context: { storefront } }: LoaderArgs) {
  ...
  return new Response(shopSitemap({ data, baseUrl: new URL(request.url).origin }), {
    headers: {
...
function shopSitemap({ data, baseUrl }: { data: SitemapQueryData; baseUrl: string }) {
